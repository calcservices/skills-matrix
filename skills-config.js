...
//
// Detects ?profile=... from the URL and loads the matching config file.
// Defaults to coder.
//
// Usage:
//   index.html?profile=analyst           → loads skills-config-analyst.js
//   index.html?profile=coder             → loads skills-config-coder.js
//   index.html?profile=servicemanager    → loads skills-config-servicemanager.js
...
(function () {
    ...
    const validProfiles = ["coder", "analyst", "servicemanager"];
